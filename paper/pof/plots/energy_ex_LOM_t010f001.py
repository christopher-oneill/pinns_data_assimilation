...
if True:
    ...
    # combined plot with both DS and PINN
        ...
        plot.subplots_adjust(left=0.1,top=0.99,right=0.85,bottom=0.09)
        ...
        ax.text(-1.5,-6,'$\scrR(\Delta E_{\mathrm{ij,DNS}})$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ticklabs = ax.get_yticklabels()
        ax.set_yticklabels(ticklabs, fontsize=8)
        ...
        ax.text(-1.5,-6,'$\scrI(\Delta E_{\mathrm{ij,DNS}})$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ax.set_xticks(xy_ticks)
        ax.set_xticks(xy_minor_ticks,minor=True)
        ...
        ax.text(-2,-6,'$\eta(\scrR(\Delta E_{\mathrm{ij,DS}}))$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ticklabs = ax.get_yticklabels()
        ax.set_yticklabels(ticklabs, fontsize=8)
        ...
        ax.text(-2,-6,'$\eta(\scrI(\Delta E_{\mathrm{ij,DS}}))$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ax.set_xticks(xy_ticks)
        ax.set_xticks(xy_minor_ticks,minor=True)
        ...
        ax.text(-2.5,-6,'$\eta(\scrR(\Delta E_{\mathrm{ij,PINN}}))$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ticklabs = ax.get_yticklabels()
        ax.set_yticklabels(ticklabs, fontsize=8)
        ...
        ax.text(-2,-6,'$\eta(\scrI(\Delta E_{\mathrm{ij,PINN}}))$',fontsize=8)
        ax.set_yticks(xy_ticks)
        ax.set_yticks(xy_minor_ticks,minor=True)
        ax.set_xticks(xy_ticks)
        ax.set_xticks(xy_minor_ticks,minor=True)
