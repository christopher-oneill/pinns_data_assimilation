...
for c in [0,1,2,3,4,5]:
    error_file = open(figures_dir+'c'+str(c)+'/snapshot_error.txt','w')
    error_file.write('FMD truncation '+str(c)+'\n')
    error_file.write('error relative to DNS: '+'\n')
    error_file.write('mean ux: '+str(mean_err_ux[:,c])+'\n')
    error_file.write('max ux: '+str(max_err_ux[:,c])+'\n')
    error_file.write('mean uy: '+str(mean_err_uy[:,c])+'\n')
    error_file.write('max uy: '+str(max_err_uy[:,c])+'\n')
    error_file.write('mean p: '+str(mean_err_p[:,c])+'\n')
    error_file.write('max p: '+str(max_err_p[:,c])+'\n')
    error_file.close()
...
if True:
    ...
    plot.savefig(figures_dir+'snapshot'+str(snapshots[sn])+'_combined_x5.png',dpi=600)
    plot.close(fig)
    ...
    plot.savefig(figures_dir+'snapshot'+str(snapshots[sn])+'_combined_x10.png',dpi=600)
    plot.close(fig)