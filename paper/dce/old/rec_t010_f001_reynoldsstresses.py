...
for ic in range(len(rec_mode_vec)):
    print('Mode ',rec_mode_vec[ic])
    print('mean uxux: ',mean_err_uxux[:,ic])
    print('max uxux: ',max_err_uxux[:,ic])
    print('mean uxuy: ',mean_err_uxuy[:,ic])
    print('max uxuy: ',max_err_uxuy[:,ic])
    print('mean uyuy: ',mean_err_uyuy[:,ic])
    print('max uyuy: ',max_err_uyuy[:,ic])


print('Err FMD Reynolds Stresses')
for ic in range(len(rec_mode_vec)):
    print('Mode ',rec_mode_vec[ic])
    print('mean uxux: ',mean_err_uxux_FMD[0,ic],'mean uxuy: ',mean_err_uxuy_FMD[0,ic],'mean uyuy: ',mean_err_uyuy_FMD[0,ic],)
    print('max uxux: ',max_err_uxux_FMD[0,ic],'max uxuy: ',max_err_uxuy_FMD[0,ic],'max uyuy: ',max_err_uyuy_FMD[0,ic],)
...
if True:
    ...
    ax.text(6,1.2,'$\eta(\overline{u\'_xu\'_x}_{\mathrm{PINN}})$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(c)',fontsize=8)
    ax.text(5.5,-1.8,'$D/\Delta x = 1.25$',fontsize=8,color='k')
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    fig.add_subplot(ax)
    ...
    plot.savefig(figures_dir+'reynoldsStress_combined.pdf')
    plot.savefig(figures_dir+'reynoldsStress_combined.png',dpi=600)
    plot.close(fig)