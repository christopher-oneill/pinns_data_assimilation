...
if True:
    for ic in range(len(rec_mode_vec)):
        ...
        for s in range(len(cases_supersample_factor)):
            ...
            ax.yaxis.set_tick_params(labelsize=5)
            ax.xaxis.set_tick_params(labelbottom=False)
            ax.text(7,1.5,'$\overline{u\'_{x}u\'_{x}}_{\mathrm{PINN}}$',fontsize=5)
            ...
            circle = plot.Circle((0,0),0.5,color='k',fill=False)
            ax.add_patch(circle)
            ax.text(7,1.5,'$|\\frac{\overline{u\'_{x}u\'_{x}}_{DNS}-\overline{u\'_{x}u\'_{x}}_{\mathrm{PINN}}}{max(\overline{u\'_{x}u\'_{x}}_{DNS})}|$',fontsize=5,color='k')
            ...
            ax.yaxis.set_tick_params(labelleft=False)
            ax.xaxis.set_tick_params(labelbottom=False)
            ax.text(7,1.5,'$\overline{u\'_{x}u\'_{y}}_{\mathrm{PINN}}$',fontsize=5)
            ...
            circle = plot.Circle((0,0),0.5,color='k',fill=False)
            ax.add_patch(circle)
            t=ax.text(7,1.5,'$|\\frac{\overline{u\'_{x}u\'_{y}}_{DNS}-\overline{u\'_{x}u\'_{y}}_{\mathrm{PINN}}}{max(\overline{u\'_{x}u\'_{y}}_{DNS})}|$',fontsize=5,color='k')
            ...
            ax.yaxis.set_tick_params(labelsize=5)
            ax.xaxis.set_tick_params(labelbottom=False)
            ax.text(7,1.5,'$\overline{u\'_{y}u\'_{y}}_{\mathrm{PINN}}$',fontsize=5)
            ...
            circle = plot.Circle((0,0),0.5,color='k',fill=False)
            ax.add_patch(circle)
            ax.text(7,1.5,'$|\\frac{\overline{u\'_{y}u\'_{y}}_{DNS}-\overline{u\'_{y}u\'_{y}}_{\mathrm{PINN}}}{max(\overline{u\'_{y}u\'_{y}}_{DNS})}|$',fontsize=5,color='k')
            ...
            ax.add_patch(circle)
            ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{x}u\'_{x}}_{DNS}$','$\overline{u\'_{x}u\'_{x}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
            fig.add_subplot(ax)
            ...
            circle = plot.Circle((0,0),0.5,color='k',fill=False,zorder=3)
            ax.add_patch(circle)
            ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{x}u\'_{y}}_{DNS}$','$\overline{u\'_{x}u\'_{y}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
            fig.add_subplot(ax)
            ...
            circle = plot.Circle((0,0),0.5,color='k',fill=False,zorder=3)
            ax.add_patch(circle)
            ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{y}u\'_{y}}_{DNS}$','$\overline{u\'_{y}u\'_{y}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
            fig.add_subplot(ax)
            ...
            if False:
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False)
                ax.add_patch(circle)
                ax.text(7,1.5,'$|\\frac{\overline{u\'_{x}u\'_{x}}-\overline{u\'_{x}u\'_{x}}_{\mathrm{PINN}}}{max(\overline{u\'_{x}u\'_{x}}_{DNS})}|$',fontsize=5,color='k')
                ax.text(-1.75,1.5,'(ac)',fontsize=5,color='k')
                fig.add_subplot(ax)
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False)
                ax.add_patch(circle)
                t=ax.text(7,1.5,'$|\\frac{\overline{u\'_{x}u\'_{y}}_{FMD}-\overline{u\'_{x}u\'_{y}}_{\mathrm{PINN}}}{max(\overline{u\'_{x}u\'_{y}}_{DNS})}|$',fontsize=5,color='k')
                ax.text(-1.75,1.5,'(bc)',fontsize=5,color='k')
                fig.add_subplot(ax)
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False)
                ax.add_patch(circle)
                ax.text(7,1.5,'$|\\frac{\overline{u\'_{y}u\'_{y}}_{FMD}-\overline{u\'_{y}u\'_{y}}_{\mathrm{PINN}}}{max(\overline{u\'_{y}u\'_{y}}_{DNS})}|$',fontsize=5,color='k')
                ax.text(-1.75,1.5,'(cc)',fontsize=5,color='k')
                fig.add_subplot(ax)
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False,zorder=3)
                ax.add_patch(circle)
                ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{x}u\'_{x}}_{FMD}$','$\overline{u\'_{x}u\'_{x}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
                fig.add_subplot(ax)
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False,zorder=3)
                ax.add_patch(circle)
                ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{x}u\'_{y}}_{FMD}$','$\overline{u\'_{x}u\'_{y}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
                fig.add_subplot(ax)
                ...
                circle = plot.Circle((0,0),0.5,color='k',fill=False,zorder=3)
                ax.add_patch(circle)
                ax.legend([line0,line1,line2],['0.0','$\overline{u\'_{y}u\'_{y}}_{FMD}$','$\overline{u\'_{y}u\'_{y}}_{\mathrm{PINN}}$'],bbox_to_anchor=(1.0,0.75),fontsize=5,framealpha=0.0)
                fig.add_subplot(ax)
...
if True:
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=outer[0],wspace=0.02,hspace=0.03,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[0][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxux_ref,levels=levels_uxux,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=outer[1],wspace=0.02,hspace=0.03,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[1][0])
    ...
    ax.text(6,1.2,'$\\frac{\overline{u\'_xu\'_x}_{\mathrm{PINN}}-\overline{u\'_xu\'_x}_{DNS}}{max(|\overline{u\'_xu\'_x}_{DNS}|)}$',fontsize=8,color='k')
    ...
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample1,y_downsample1,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(6,1.2,'$\\frac{\overline{u\'_xu\'_y}_{\mathrm{PINN}}-\overline{u\'_xu\'_y}_{DNS}}{max(|\overline{u\'_xu\'_y}_{DNS}|)}$',fontsize=8,color='k')
    ...
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample1,y_downsample1,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(6,1.2,'$\\frac{\overline{u\'_yu\'_y}_{\mathrm{PINN}}-\overline{u\'_yu\'_y}_{DNS}}{max(|\overline{u\'_yu\'_y}_{DNS}|)}$',fontsize=8,color='k')
    ...
    plot.savefig(figures_dir+'c5/logerr_reynoldsStress_contours_ref_pinn_condensed_c5.pdf')
    plot.savefig(figures_dir+'c5/logerr_reynoldsStress_contours_ref_pinn_condensed_c5.png',dpi=300)
    plot.close(fig)
...
for ic in range(len(rec_mode_vec)):
    error_file = open(figures_dir+'c'+str(rec_mode_vec[ic])+'/reynoldsStress_error.txt','w')
    error_file.write('Err PINN Reynolds Stresses, Mode '+str(rec_mode_vec[ic])+'\n')
    error_file.write('mean uxux: '+str(mean_err_uxux[:,ic])+'\n')
    error_file.write('max uxux: '+str(max_err_uxux[:,ic])+'\n')
    error_file.write('mean uxuy: '+str(mean_err_uxuy[:,ic])+'\n')
    error_file.write('max uxuy: '+str(max_err_uxuy[:,ic])+'\n')
    error_file.write('mean uyuy: '+str(mean_err_uyuy[:,ic])+'\n')
    error_file.write('max uyuy: '+str(max_err_uyuy[:,ic])+'\n')
    error_file.close()
...
if True:
    ...
    uxux_pred_grid1 = uxux_rec[s][ic]
    uxuy_pred_grid1 = uxuy_rec[s][ic]
    uyuy_pred_grid1 = uyuy_rec[s][ic]

    uxux_pred_grid1[cylinder_mask]=np.NaN
    uxuy_pred_grid1[cylinder_mask]=np.NaN
    uyuy_pred_grid1[cylinder_mask]=np.NaN
    ...
    s=5
    label_2 = xD_labels[s]
    uxux_pred_grid2 = uxux_rec[s][ic]
    uxuy_pred_grid2 = uxuy_rec[s][ic]
    uyuy_pred_grid2 = uyuy_rec[s][ic]

    uxux_pred_grid2[cylinder_mask]=np.NaN
    uxuy_pred_grid2[cylinder_mask]=np.NaN
    uyuy_pred_grid2[cylinder_mask]=np.NaN
    ...
    # mode 0 summary, dual log scale error plots
    fig = plot.figure(figsize=(5.85,5.8))
    plot.subplots_adjust(left=0.06,top=0.99,right=0.93,bottom=0.06)
    outer = gridspec.GridSpec(2,2,wspace=0.35,hspace=0.12)
    mid = []
    mid.append(gridspec.GridSpecFromSubplotSpec(3,1,subplot_spec=outer[0],wspace=0.05,hspace=0.1,height_ratios=[1,1,1]))
    inner = []

    x_ticks = np.array([-2,0,2,4,6,8,10])
    # quadrant 1

    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][0],wspace=0.05,hspace=0.03,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[0][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxux_ref,levels=levels_uxux,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][1],wspace=0.05,hspace=0.03,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[1][0])
    ...
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample1,y_downsample1,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(6,1.2,'$\eta(\overline{u\'_xu\'_x}_{\mathrm{PINN}})$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(b)',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    fig.add_subplot(ax)
    ...
    ax.text(6,1.2,'$\eta(\overline{u\'_xu\'_x}_{\mathrm{PINN}})$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(c)',fontsize=8)
    ax.text(5.5,-1.8,'$D/\Delta x = '+label_2+'$',fontsize=8,color='k')
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    fig.add_subplot(ax)
    ...
    mid.append(gridspec.GridSpecFromSubplotSpec(3,1,subplot_spec=outer[1],wspace=0.05,hspace=0.1,height_ratios=[1,1,1]))
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][1],wspace=0.02,hspace=0.1,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[4][0])
    ...
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample1,y_downsample1,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(6,1.2,'$\eta(\overline{u\'_xu\'_y}_{\mathrm{PINN}})$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(e)',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    ...
    mid.append(gridspec.GridSpecFromSubplotSpec(3,1,subplot_spec=outer[2],wspace=0.05,hspace=0.1,height_ratios=[1,1,1]))
    ...
    ax.set_xticks(x_ticks)
    ax.xaxis.set_tick_params(labelbottom=False)
    ax.text(7,1.3,'$\overline{u\'_yu\'_y}_{\mathrm{DNS}}$',fontsize=8)
    ax.text(-1.85,1.45,'(g)',fontsize=8)
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    fig.add_subplot(ax)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][1],wspace=0.02,hspace=0.1,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[7][0])
    ...
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample1,y_downsample1,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(6,1.2,'$\eta(\overline{u\'_yu\'_y}_{\mathrm{PINN}})$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(h)',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    ...
    mid.append(gridspec.GridSpecFromSubplotSpec(2,1,subplot_spec=outer[3],wspace=0.05,hspace=0.1,height_ratios=[0.3,0.7]))

    inner.append(inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[3][1],wspace=0.02,hspace=0.1,width_ratios=[0.1,0.9])))

    ic = len(rec_mode_vec)-1 # use all modes
    ...
    mean_plt_uxux,=ax.plot(pts_per_d*0.9,mean_err_uxux[:,ic],linewidth=0,marker='o',color='blue',markersize=3,markerfacecolor='blue')
    max_plt_uxux,=ax.plot(pts_per_d*0.9,max_err_uxux[:,ic],linewidth=0,marker='v',color='blue',markersize=3,markerfacecolor='blue')
    mean_plt_uxuy,=ax.plot(pts_per_d,mean_err_uxuy[:,ic],linewidth=0,marker='o',color='red',markersize=3,markerfacecolor='red')
    max_plt_uxuy,=ax.plot(pts_per_d,max_err_uxuy[:,ic],linewidth=0,marker='v',color='red',markersize=3,markerfacecolor='red')
    mean_plt_uyuy,=ax.plot(pts_per_d*1.1,mean_err_uyuy[:,ic],linewidth=0,marker='o',color='green',markersize=3,markerfacecolor='green')
    max_plt_uyuy,=ax.plot(pts_per_d*1.1,max_err_uyuy[:,ic],linewidth=0,marker='v',color='green',markersize=3,markerfacecolor='green')
    ...
    ax.set_yticks([1E-4,1E-3,1E-2,1E-1,1],labels=error_y_tick_labels,fontsize=8)
    ax.set_ylabel("Error ($\eta$)",fontsize=8)
    ax.legend([mean_plt_uxux,max_plt_uxux,mean_plt_uxuy,max_plt_uxuy,mean_plt_uyuy,max_plt_uyuy,],['Mean $\overline{u\'_xu\'_x}$','Max $\overline{u\'_xu\'_x}$','Mean $\overline{u\'_xu\'_y}$','Max $\overline{u\'_xu\'_y}$','Mean $\overline{u\'_yu\'_y}$','Max $\overline{u\'_yu\'_y}$',],fontsize=8,ncols=2,bbox_to_anchor=(1.05, 1.5))
    ax.grid('on')
    ax.set_xlabel('$D/\Delta x$',fontsize=8,labelpad=-1)
    ax.text(1.5,0.2,'(j)',fontsize=8)

    fig.add_subplot(ax)


    #plot.savefig(figures_dir+'reynoldsStress_combined_x5.pdf')
    plot.savefig(figures_dir+'reynoldsStress_combined_x5.png',dpi=600)
    plot.close(fig)
    ...
    outer = gridspec.GridSpec(2,2,wspace=0.23,hspace=0.04)
    mid = []
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][0],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[0][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxux_ref,levels=levels_uxux,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][1],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[1][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxux_pred_grid1,levels=levels_uxux,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ax.xaxis.set_tick_params(labelbottom=False)
    ax.text(7,1.3,'$\overline{u\'_xu\'_x}_{\mathrm{PINN}}$',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(b)',fontsize=8)
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][2],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[2][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxux_pred_grid2,levels=levels_uxux,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ax.xaxis.set_tick_params(labelbottom=False)
    ax.text(7,1.3,'$\overline{u\'_xu\'_x}_{\mathrm{PINN}}$',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_2+'$',fontsize=8,color='k')
    if cases_supersample_factor[s]>1:
        dots = ax.plot(x_downsample2,y_downsample2,markersize=2,linewidth=0,color='k',marker='.',fillstyle='full',markeredgecolor='none')
    ax.text(-1.85,1.45,'(c)',fontsize=8)
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][3],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[3][0])
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[0][4],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[4][0])
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][0],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[5][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxuy_ref,levels=levels_uxuy,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][1],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[6][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxuy_pred_grid1,levels=levels_uxuy,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ax.xaxis.set_tick_params(labelbottom=False)
    ax.text(7,1.3,'$\overline{u\'_xu\'_y}_{\mathrm{PINN}}$',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    ax.text(-1.85,1.45,'(g)',fontsize=8)
    circle = plot.Circle((0,0),0.5,color='k',fill=False)
    ax.add_patch(circle)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][2],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[7][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uxuy_pred_grid2,levels=levels_uxuy,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][3],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[8][0])
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[1][4],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][0],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][1],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[11][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uyuy_pred_grid1,levels=levels_uyuy,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ax.xaxis.set_tick_params(labelbottom=False)
    ax.text(7,1.3,'$\overline{u\'_yu\'_y}_{\mathrm{PINN}}$',fontsize=8)
    ax.text(6,-1.8,'$D/\Delta x = '+label_1+'$',fontsize=8,color='k')
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][2],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ax = plot.Subplot(fig,inner[12][0])
    ux_plot = ax.contourf(X_grid,Y_grid,uyuy_pred_grid2,levels=levels_uyuy,cmap= matplotlib.colormaps['bwr'],extend='both')
    ax.set_aspect('equal')
    ax.set_ylabel('y',fontsize=8,labelpad=-5)
    ax.yaxis.set_tick_params(labelsize=8)
    ax.set_xticks(x_ticks)
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][3],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ...
    inner.append(gridspec.GridSpecFromSubplotSpec(1,2,subplot_spec=mid[2][4],wspace=0.02,hspace=0.01,width_ratios=[0.97,0.03]))
    ...
    ax.set_yticks([1E-4,1E-3,1E-2,1E-1,1],labels=error_y_tick_labels,fontsize=8)
    ax.set_ylabel("Error ($\eta$)",fontsize=8)
    ax.legend([mean_plt_uxux,max_plt_uxux,mean_plt_uxuy,max_plt_uxuy,mean_plt_uyuy,max_plt_uyuy,],['Mean $\overline{u\'_xu\'_x}$','Max $\overline{u\'_xu\'_x}$','Mean $\overline{u\'_xu\'_y}$','Max $\overline{u\'_xu\'_y}$','Mean $\overline{u\'_yu\'_y}$','Max $\overline{u\'_yu\'_y}$',],fontsize=8,ncols=2,bbox_to_anchor=(1.0, 1.3))
    ax.grid('on')
    ax.set_xlabel('$D/\Delta x$',fontsize=8,labelpad=-1)
    ...
    plot.savefig(figures_dir+'reynoldsStress_combined_x10.png',dpi=600)
    plot.close(fig)
