...
if True:
    for ic in range(len(rec_mode_vec)):
        ...
        for s in range(len(cases_supersample_factor)):
            ...
            ux_plot = ax.contourf(X_grid,Y_grid,np.abs((uxux_ref-uxux_rec[s][ic])/MAX_uxux_ref)+1E-30,levels=levels_err,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
            ax.set_aspect('equal')
            ax.set_ylabel('y/D',fontsize=5)
            ax.yaxis.set_tick_params(labelsize=5)
            ax.xaxis.set_tick_params(labelbottom=False)
            ...
            uy_plot = ax.contourf(X_grid,Y_grid,np.abs((uxuy_ref-uxuy_rec[s][ic])/MAX_uxuy_ref)+1E-30,levels=levels_err,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
            ax.set_aspect('equal')
            ax.set_yticks(np.array([2.0,1.0,0.0,-1.0,-2.0]))
            ax.xaxis.set_tick_params(labelbottom=False)
            ax.yaxis.set_tick_params(labelleft=False)
            ...
            p_plot = ax.contourf(X_grid,Y_grid,np.abs((uyuy_ref-uyuy_rec[s][ic])/MAX_uyuy_ref)+1E-30,levels=levels_err,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
            ax.set_aspect('equal')
            ax.yaxis.set_tick_params(labelsize=5)
            ax.set_ylabel('y/D',fontsize=5)
            ...
            plot.savefig(figures_dir+'logerr_reynoldsStress_contours_ref_pinn_S'+str(cases_supersample_factor[s])+'_c'+str(rec_mode_vec[ic])+'.pdf')
            plot.savefig(figures_dir+'logerr_reynoldsStress_contours_ref_pinn_S'+str(cases_supersample_factor[s])+'_c'+str(rec_mode_vec[ic])+'.png',dpi=300)
            plot.close('all')
...
if True:
    ...
    plot.savefig(figures_dir+'logerr_reynoldsStress_contours_ref_pinn_condensed_c5.pdf')
    plot.savefig(figures_dir+'logerr_reynoldsStress_contours_ref_pinn_condensed_c5.png',dpi=300)
    plot.close(fig)
...
for ic in range(len(rec_mode_vec)):
    ...
    mean_plt,=axs[0].plot(pts_per_d,mean_err_uxux[:,ic],linewidth=0,marker='o',color='black',markersize=3,markerfacecolor='black')
    p95_plt,=axs[0].plot(pts_per_d,p95_err_uxux[:,ic],linewidth=0,marker='^',color='orange',markersize=3,markerfacecolor='orange')
    max_plt,=axs[0].plot(pts_per_d,max_err_uxux[:,ic],linewidth=0,marker='v',color='red',markersize=3,markerfacecolor='red')
    ...
    axs[1].plot(pts_per_d,mean_err_uxuy[:,ic],linewidth=0,marker='o',color='black',markersize=3,markerfacecolor='black')
    axs[1].plot(pts_per_d,p95_err_uxuy[:,ic],linewidth=0,marker='^',color='orange',markersize=3,markerfacecolor='orange')
    axs[1].plot(pts_per_d,max_err_uxuy[:,ic],linewidth=0,marker='v',color='red',markersize=3,markerfacecolor='red')
    ...
    axs[2].plot(pts_per_d,mean_err_uyuy[:,ic],linewidth=0,marker='o',color='black',markersize=3,markerfacecolor='black')
    axs[2].plot(pts_per_d,p95_err_uyuy[:,ic],linewidth=0,marker='^',color='orange',markersize=3,markerfacecolor='orange')
    axs[2].plot(pts_per_d,max_err_uyuy[:,ic],linewidth=0,marker='v',color='red',markersize=3,markerfacecolor='red')
    ...
    #fig.tight_layout()
    plot.savefig(figures_dir+'logerr_rec_reynoldsStress_f'+str(rec_mode_vec[ic])+'_error.pdf')
    plot.savefig(figures_dir+'logerr_rec_reynoldsStress_f'+str(rec_mode_vec[ic])+'_error.png',dpi=300)
    plot.close(fig)
    ...
    #fig.tight_layout()
    plot.savefig(figures_dir+'logerr_rec_reynoldsStress_f'+str(rec_mode_vec[ic])+'_error_FMD.pdf')
    plot.savefig(figures_dir+'logerr_rec_reynoldsStress_f'+str(rec_mode_vec[ic])+'_error_FMD.png',dpi=300)
    plot.close(fig)
