...
for s in range(len(cases_supersample_factor)):
    for c in [0,1,2]:
        ...
        ux_plot = ax.contourf(X_grid,Y_grid,np.abs(phi_xr_err_grid/MAX_plot_phi_xr)+1E-30,levels=levels_mx,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
        ax.set_aspect('equal')
        ax.set_ylabel('y/D',fontsize=5)
        ax.yaxis.set_tick_params(labelsize=5)
        ax.xaxis.set_tick_params(labelbottom=False)
        ...
        uy_plot = ax.contourf(X_grid,Y_grid,np.abs(phi_yr_err_grid/MAX_plot_phi_yr)+1E-30,levels=levels_mx,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
        ax.set_aspect('equal')
        ax.set_yticks(np.array([2.0,1.0,0.0,-1.0,-2.0]))
        ax.xaxis.set_tick_params(labelbottom=False)
        ax.yaxis.set_tick_params(labelleft=False)
        ...
        p_plot = ax.contourf(X_grid,Y_grid,np.abs(psi_r_err_grid/MAX_plot_psi_r)+1E-30,levels=levels_mx,norm=matplotlib.colors.LogNorm(),cmap= matplotlib.colormaps['hot_r'],extend='both')
        ax.set_aspect('equal')
        ax.yaxis.set_tick_params(labelsize=5)
        ax.set_ylabel('y/D',fontsize=5)
        ...
        m_plot =ax.contourf(X_grid,Y_grid,np.abs(mx_grid)+1E-30,levels=levels_mx,cmap= matplotlib.colormaps['hot_r'],norm=matplotlib.colors.LogNorm(),extend='both')
        ax.set_aspect('equal')
        ...
        m_plot =ax.contourf(X_grid,Y_grid,np.abs(my_grid)+1E-30,levels=levels_my,cmap= matplotlib.colormaps['hot_r'],norm=matplotlib.colors.LogNorm(),extend='both')
        ax.set_aspect('equal')
        ...
        m_plot =ax.contourf(X_grid,Y_grid,np.abs(mass_grid)+1E-30,levels=levels_mass,cmap= matplotlib.colormaps['hot_r'],norm=matplotlib.colors.LogNorm(),extend='both')
        ax.set_aspect('equal')
        ax.set_xlabel('x/D',fontsize=5)
        ax.set_yticks(np.array([2.0,1.0,0.0,-1.0,-2.0]))
        ax.xaxis.set_tick_params(labelsize=5)
