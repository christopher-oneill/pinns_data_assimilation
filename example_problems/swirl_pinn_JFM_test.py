...
hist = model.fit(X_train, O_train, batch_size=512, epochs=5, callbacks=[early_stop_callback,model_checkpoint_callback])


tfkeras.backend.set_value(model.optimizer.learning_rate, 0.005)
model.load_weights(checkpoint_filepath)
hist = model.fit(X_train, O_train, batch_size=512, epochs=10, callbacks=[early_stop_callback,model_checkpoint_callback])


tfkeras.backend.set_value(model.optimizer.learning_rate, 0.001)
model.load_weights(checkpoint_filepath)
hist = model.fit(X_train, O_train, batch_size=512, epochs=25, callbacks=[early_stop_callback,model_checkpoint_callback])


model.load_weights(checkpoint_filepath)
tfkeras.backend.set_value(model.optimizer.learning_rate, 0.0001)
hist = model.fit(X_train, O_train, batch_size=512, epochs=50, callbacks=[early_stop_callback,model_checkpoint_callback])
