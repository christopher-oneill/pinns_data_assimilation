...
global savedir
savedir = HOMEDIR+'output/mfg_res_mean6_001/'
...
if True:
    ...
    lr_schedule = np.array([5E-5, 5E-5, 1E-5, 5E-6, 1E-6, 5E-6])
    ep_schedule = np.array([0, 50, 200, 300, 400])
    phys_schedule = np.array([1E-6, 1E-3, 1E-3, 1E-3, 1E-3, 1E-3])
