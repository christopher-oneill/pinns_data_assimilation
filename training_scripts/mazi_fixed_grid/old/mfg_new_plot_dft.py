...
mode_number_array = np.array([0,1])
supersample_factor_list = [1,4,8]
...
for mn in range(mode_number_array.size):
    ...
    for p in range(len(supersample_factor_list)):
        ...
        case_prefix = 'mfg_new2_dft'+str(mode_number)+'_S'+str(supersample_factor)+'_j'
        ...
        for k in training_cases:
            ...
            max_err = np.nanmax(np.abs((phi_xr_grid-phi_xr_pred_grid)/MAX_phi_xr))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(phi_xr_grid-phi_xr_pred_grid)/MAX_phi_xr,levels=levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.ylabel('y/D')
            plot.xlabel('x/D')
            ...
            max_err = np.nanmax(np.abs((phi_xi_grid-phi_xi_pred_grid)/MAX_phi_xi))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(phi_xi_grid-phi_xi_pred_grid)/MAX_phi_xi,levels=levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.ylabel('y/D')
            plot.xlabel('x/D')
            ...
            max_err = np.nanmax(np.abs((phi_yr_grid-phi_yr_pred_grid)/MAX_phi_yr))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(phi_yr_grid-phi_yr_pred_grid)/MAX_phi_yr,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((phi_yi_grid-phi_yi_pred_grid)/MAX_phi_yi))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(phi_yi_grid-phi_yi_pred_grid)/MAX_phi_yi,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((psi_r_grid-psi_r_pred_grid)/MAX_psi_r))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(psi_r_grid-psi_r_pred_grid)/MAX_psi_r,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((psi_i_grid-psi_i_pred_grid)/MAX_psi_i))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(psi_i_grid-psi_i_pred_grid)/MAX_psi_i,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_xx_r_grid-tau_xx_r_pred_grid)/MAX_tau_xx_r))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_xx_r_grid-tau_xx_r_pred_grid)/MAX_tau_xx_r,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_xx_i_grid-tau_xx_i_pred_grid)/MAX_tau_xx_i))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_xx_i_grid-tau_xx_i_pred_grid)/MAX_tau_xx_i,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_xy_r_grid-tau_xy_r_pred_grid)/MAX_tau_xy_r))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_xy_r_grid-tau_xy_r_pred_grid)/MAX_tau_xy_r,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_xy_i_grid-tau_xy_i_pred_grid)/MAX_tau_xy_i))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_xy_i_grid-tau_xy_i_pred_grid)/MAX_tau_xy_i,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_yy_r_grid-tau_yy_r_pred_grid)/MAX_tau_yy_r))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_yy_r_grid-tau_yy_r_pred_grid)/MAX_tau_yy_r,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
            ...
            max_err = np.nanmax(np.abs((tau_yy_i_grid-tau_yy_i_pred_grid)/MAX_tau_yy_i))
            levels_err = np.linspace(-max_err,max_err,21)
            plot.contourf(X_grid,Y_grid,(tau_yy_i_grid-tau_yy_i_pred_grid)/MAX_tau_yy_i,levels_err)
            plot.set_cmap('bwr')
            plot.colorbar()
            plot.axis('equal')
            plot.ylabel('y/D')
