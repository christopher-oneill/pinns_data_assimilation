...
ScalingParameters.data_loss_coefficient=10.0
...
if True:
    ...
    ep_schedule = np.array([        0,     50,      150,    250,     350,         ])
    phys_schedule = np.array([      1E-2,   1E-2,   1E-2,   1E-2,    1E-2,       ])
