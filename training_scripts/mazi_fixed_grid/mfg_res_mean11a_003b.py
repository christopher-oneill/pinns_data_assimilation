...
if len(checkpoint_files)>0:
    ...
    with tf.device(tf_device_string):        
        ...
        lo = QresBlock2(31,activation=keras.activations.tanh,dtype=tf_dtype)(inputs)
        for i in range(10):
            lo = QresBlock2(31,activation=keras.activations.tanh,dtype=tf_dtype)(lo)
        for i in range(4):
            lo = QresBlock2(71,activation=keras.activations.tanh,dtype=tf_dtype)(lo)
        for i in range(5):
