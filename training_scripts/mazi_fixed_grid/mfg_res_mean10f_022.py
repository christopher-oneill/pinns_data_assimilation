...
if False:
    ...
    with tf.device(tf_device_string):        
        ...
        lo = ResidualLayer(150,activation='swish')(inputs)
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo) 
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo)  #5
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo)
        lo = ResidualLayer(150,activation='swish')(lo) #10
...
if False:
    ...
    ep_schedule = np.array([         0,       100,    300,     500,    700,     900,    1100,      1600,       ])
