...
# copy the arrays so the training set size is consistent (so epochs are the smame duration)
...
ScalingParameters.colloc_batch_size=128
history_list = []
