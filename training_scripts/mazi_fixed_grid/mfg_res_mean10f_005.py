...
if True:
    ...
    ep_schedule = np.array([        0,     50,     150,   250,     350,     1200,   1300,  ])
    phys_schedule = np.array([      1E-6,   1E-6,  1E-6,  1E-6,    1E-6,    1E-6,   1E-6,  ])
