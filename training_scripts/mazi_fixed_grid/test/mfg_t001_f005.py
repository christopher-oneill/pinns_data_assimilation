...
if __name__=="__main__":
    ...
    with tf.device('/CPU:0'):
        mean_model_filename,mean_training_steps = find_highest_numbered_file(PROJECTDIR+'output/mfg_t001_001_S'+str(supersample_factor)+'/mfg_t001_001_S'+str(supersample_factor)+'_ep','[0-9]*','_model.h5')
