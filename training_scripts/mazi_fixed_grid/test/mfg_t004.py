...
global job_name 
job_name = 'mfg_t004_{:03d}_S{:d}'.format(job_number,supersample_factor)
...
if model_filename is not None:
    ...
    with tf.device(tf_device_string):        
        ...
        lo = QuadraticInputPassthroughLayer(71,2,activation='tanh')(inputs)
        for i in range(9):
            lo=QuadraticInputPassthroughLayer(71,2,activation='tanh')(lo)
