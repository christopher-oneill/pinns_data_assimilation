...
def compute_loss(x,y,colloc_x,boundary_tuple,ScalingParameters):
    ...
    total_loss = ScalingParameters.physics_loss_coefficient*data_loss + ScalingParameters.physics_loss_coefficient*physics_loss + ScalingParameters.boundary_loss_coefficient*boundary_loss
...
global job_name 
job_name = 'mfg_t010_{:03d}_S{:d}'.format(job_number,supersample_factor)
