...
if False:
    ...
    lr_schedule = np.array([         1E-4, 3.3E-5,  1E-5, 3.3E-6,  1E-6,       1E-5,        3.3E-6, 1E-6 ])
    ep_schedule = np.array([        0,     50,     200,   500,     550,         2000,       3000, ])
    phys_schedule = np.array([      1E-6,   1E-6,  1E-6,  1E-6,    1E-6,       1E-4,        1E-4, ])
