...
inlet_BC_x = np.concatenate((-10.0*np.ones([1000,])/ScalingParameters.MAX_x,np.linspace(-10,10,1000)/ScalingParameters.MAX_x,np.linspace(-10,10,1000)/ScalingParameters.MAX_x,),axis=0)
inlet_BC_y = np.concatenate((np.linspace(-10.0,10.0,1000)/ScalingParameters.MAX_y,10.0*np.ones([1000,])/ScalingParameters.MAX_y,-10.0*np.ones([1000,])/ScalingParameters.MAX_y),axis=0)
...
if True:
    ...
    ep_schedule = np.array([        0,       1000,     1000,      1000,   1000, ])
    phys_schedule = np.array([      1E0,   1E0,  1E0,        1E0,    1E0, ])
