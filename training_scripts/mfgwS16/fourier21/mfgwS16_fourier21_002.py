...
job_name = 'mfgwS16_fourier21_002'
...
mode_number=21-1 # the number of the truncated mode to assimilate, note that this is mode 9 in matlab!
...
fourierModeFile = h5py.File(base_dir+'fourierDataShortS16.mat','r')
...
with tf.device('/CPU:0'):
    model_mean = keras.models.load_model(HOMEDIR+'output/mfgwS16m002_output/mfgwS16m002_ep120800_model.h5',custom_objects={'mean_loss':mean_loss_wrapper(f_colloc_train),})
