...
def load_custom():
    ...
    model_RANS = keras.models.load_model(checkpoint_filename,custom_objects={'QuadraticInputPassthroughLayer':QuadraticInputPassthroughLayer})
    model_RANS.summary()
...
global job_name 
job_name = 'mf_dense004_{:03d}_S{:d}'.format(job_number,supersample_factor)
