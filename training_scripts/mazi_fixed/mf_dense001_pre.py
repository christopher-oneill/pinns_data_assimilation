...
def compute_loss(x,y,colloc_x,boundary_tuple,ScalingParameters):
    ...
    boundary_loss = tf.cast(1.0E-12,tf_dtype)#ScalingParameters.boundary_loss_coefficient*RANS_boundary_loss(model_RANS,ScalingParameters,boundary_tuple)
...
while backprop_flag:
    ...
    # regular training
    lr_schedule = np.array([3.3E-6, 1E-6,   3.3E-7,  1E-7,   3.3E-8,     1E-8,   0.0])
    ep_schedule = np.array([0,      100,     200,     300,    400,        500,    600])
