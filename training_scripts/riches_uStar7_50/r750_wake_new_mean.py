...
job_name = 'r750_wake_new_mean{:03d}_S{:d}'.format(job_number,supersample_factor)
...
def colloc_points():
    ...
    colloc_limits1 = np.array([[-0.014,0.12],[-0.071,0.051]])
    colloc_sample_lhs1 = LHS(xlimits=colloc_limits1)
    colloc_lhs1 = colloc_sample_lhs1(80000)


    colloc_limits2 = np.array([[-0.014,(3-0.5)*d-0.014],[-2.5*d,1.5*d]])
...
def BC_no_slip(BC_points):
    # we return zero because there is no cylinder
    return 0.0
