...
for mn in range(mode_number_array.size):
    ...
    # script
    mode_number_matlab = mode_number_array[mn]
    mode_number=mode_number_matlab-1 # equivalent to 9 in matlab notation 

    base_dir = 'C:/projects/pinns_beluga/sync/'
    data_dir = base_dir+'data/mazi_fixed_grid_wake/'
    case_prefix = 'mfgw_fourier'+str(mode_number_matlab)+'_'
